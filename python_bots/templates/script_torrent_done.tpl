...
scp -P ${storage_port} -i ~/.ssh/id_rsa -r \$TR_TORRENT_DIR pi@${storage_host}:\$REMOTE_DIR 1>>\$LOG_FILE 2>>\$LOG_FILE && echo "\$TR_TORRENT_DIR successfully copied" >>\$LOG_FILE 2>&1
