...
TELEGRAM_BOT_TOKEN=${best_wines_tg_token} TELEGRAM_CHAT_ID=${best_wines_chat_id} CHROME_TIMEOUT=${chrome_timeout} TELEGRAPH_TOKEN=${telegraph_token} python3 app/best_wines_sweden.py || true
